...
namespace BB
{
    public class ScnManager : MonoBehaviour
    {
        ...
        const string SCN_MANAGER_INSTANCENAME = "BB_ScnMain";
        const string SCN_MANAGER_INSTANCECAMERA = "BB_ScnCamera";
        ...
        {
            return GetObject(SCN_MANAGER_INSTANCECAMERA).GetComponent<Camera>();
        }
        ...
        {
            BBInternal.SCENEManager.ChangeScene(name);
        }
        /// <summary>
